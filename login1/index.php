...
{
//$sobject1 = new Sobject($record);
//echo $sobject1 ->Id;
//echo $sobject1 ->LastName;
//$sobject1->ContentDocumentIds__c
...
if ($zip->open($zip_name, ZipArchive::CREATE) === TRUE )
{
	foreach($response as $attachment) {
		...
		//$sobject = new Sobject($attachment);
		//echo $sobject ->Id;
		//echo $sobject ->Title;
		$zip->addFromString($attachment->fields->Title,base64_decode($attachment->fields->VersionData));
		//echo $sobject ->VersionData;
	}
	//echo $zip_name.' created and path is '.$path.'<br><br>';
}
if ($zip->open($zip_name, ZipArchive::CREATE) != TRUE )
{
...
//$connectionString = "DefaultEndpointsProtocol=https;AccountName=".getenv('azureabsyz').";AccountKey=".getenv('M8oCxYRkVRD0HmSML68XmdFBB1Nygcr8+xZQwAPxr6EeqKXLbAA9IRmTEMVXdVfC1RvszyckDDPmAeIhZCYyAw==');
